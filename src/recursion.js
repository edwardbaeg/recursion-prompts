...
var exponent = function(base, exp) {
  ...
  if (exp > 0) {
    ...
    return +((1.0 / base) * exponent(base, exp + 1)).toFixed(9);
  }
};
...
var compress = function(list) {
  ...
  return [next].concat(compress(copy));
};
...
var minimizeZeroes = function(array) {
  ...
  if (array[0] === 0) {
    ...
    return [0].concat(minimizeZeroes(array));
  }
...
var numToText = function(str) {
  ...
  if (+str[0] in numMap) {
    return numMap[str[0]] + numToText(str.slice(1));
  } else {
